...
public class TitleBookState implements Serializable {
    //Book fields
    private Long bid;
    private int copy;
    ...
    private List bookStateList = new ArrayList();

    //Title to Book
    public TitleBookState(String ISBN, String title, String author, String publisher, List bookStateList){
        this.ISBN            = ISBN;
        this.title           = title;
        this.author          = author;
    ...
    //Book to Title
    public TitleBookState(Long bid, int copy, Date loan, Date due,
    ...
    public List getBookStateList() {
        return bookStateList;
    }

    public void setBookStateList(List bookStateList) {
        this.bookStateList = bookStateList;
    }
